...
borderValue = 10
inputWindowSize = (800,300)
outputWindowSize = (800,350)
mixerWindowSize = (1150,600)
mainWindowSize = (500,250)
...
class mixerWindow(wx.Frame):
    ...
    def __init__(self, parent, apogeeinfo = None, dev = None, num = None):
        ...
        while (mixerindex < num):
            ...
            vbox.Add(mtitle, flag=wx.EXPAND |  wx.BOTTOM | wx.TOP | wx.LEFT | wx.RIGHT, border=borderValue)
            ...
            while (channel < apogeeinfo["mixerChannel_Num"]):                  # strips are produced per channel
                ...
                hbox.Add(sp, flag=wx.EXPAND |  wx.BOTTOM | wx.TOP | wx.LEFT | wx.RIGHT, border=borderValue)
            ...
            hbox.Add(softRtnPanel, flag=wx.EXPAND |  wx.BOTTOM | wx.TOP | wx.LEFT | wx.RIGHT, border=borderValue)
            ...
            hbox.Add(masterPanel, flag=wx.EXPAND |  wx.BOTTOM | wx.TOP | wx.LEFT | wx.RIGHT, border=borderValue)
